        ...
        {cart.items.length === 0 ? (
          <div className="flex w-full flex-col items-center justify-center p-10">
            <Image
              ...
              alt="io-cart"
            />
            <p className="text-io-text-secondary text-lg">Cart is empty</p>
          ...
          <Table>
            <TableHeader className="bg-io-background-tertiary h-14">
              <TableRow>
            ...
            <TableBody>
              {cart.items.map((item) => (
                <TableRow
                  key={item.id}
                  className="border-io-background-tertiary h-24 border-b border-dashed"
                >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <Link href={`/shop/${item.slug}`}>
                          <p className="text-io-text-primary"> {item.name}</p>
                        </Link>
                        <p className="text-io-text-secondary pt-1 text-sm">
                          {item.subAttributes}
                        </p>
                      </div>
                    </div>
