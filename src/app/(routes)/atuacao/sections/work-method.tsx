      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
        {STEPS.map((step, i) => (
          <ElementReveal
            ...
            distance="24px"
            variant="card"
            className="group interactive-card interactive-card-dark relative rounded-3xl border border-white/10 bg-white/5 p-10 transition-all duration-500 hover:border-[#c5a47e]/30"
          >
