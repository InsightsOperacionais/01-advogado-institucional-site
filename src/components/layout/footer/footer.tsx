          ...
          <div className="flex flex-col lg:col-span-5">
            ...
            >
              <p className="mt-8 max-w-sm text-sm leading-relaxed font-light text-white/50">
                Comprometidos com a excelência jurídica e a defesa estratégica
                dos interesses de nossos constituintes. Uma trajetória moldada
                pela ética, rigor técnico e resultados de alto impacto.
              </p>
            </ElementReveal>
